...
int main(int argc, char** argv) {
	...
	//string keyBin = "1010101010111011000010010001100000100111001101101100110011011101";
	//string inputBin = "1010101111001101111001101010101111001101000100110010010100110110";
